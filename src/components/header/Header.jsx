...
export default function Header() {
  return (
    <div className="flex flex-col items-center justify-center fixed w-full bg-white z-50">
      ...
      <div className="py-1.5 flex w-full text-sm items-center justify-center bg-primary text-white">
