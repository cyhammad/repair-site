              ...
              <div>
                ...
                <div className="pt-4 relative px-4">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-secondary text-xs md:text-sm lg:text-base h-40 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
                  >
            ...
            <div className="flex gap-4 flex-col  w-full">
              ...
              <div className="flex justify-center items-center flex-col">
                ...
                <motion.p
                  ...
                  className="text-secondary text-lg font-bold mb-5 text-center md:text-left"
                >
                  {card.description}
                </motion.p>
